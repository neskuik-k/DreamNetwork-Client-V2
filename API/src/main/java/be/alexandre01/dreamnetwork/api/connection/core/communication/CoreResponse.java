...
public abstract class CoreResponse {
    ...
    public void onAutoResponse(Message message, ChannelHandlerContext ctx, UniversalConnection client){
    ...
    protected void onResponse(Message message, ChannelHandlerContext ctx, UniversalConnection client) throws Exception {
        // override this
    }
