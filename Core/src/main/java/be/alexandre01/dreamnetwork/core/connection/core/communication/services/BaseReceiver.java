...
public class BaseReceiver extends CoreReceiver {
    private final Core core;
    HashMap<String, CoreReceiver.RequestInterceptor> tasks = AbstractRequestManager.getTasks();
    RequestInterceptor start = StartTask.get();

    public BaseReceiver() {

        this.core = Core.getInstance();
        getSubReceivers().add(new UniversalDataReceiver());
