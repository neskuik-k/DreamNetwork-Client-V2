                         ...
                         if(args[3].equalsIgnoreCase("STATIC")){
                             ...
                             if(args.length == 7){
                                 try {
                                     ...
                                     jvmExecutor.updateConfigFile(args[1],args[2], JVMExecutor.Mods.STATIC,args[4],args[5],Integer.parseInt(args[6]),proxy,null);
                                 ...
                                 try {
                                     ...
                                     jvmExecutor.updateConfigFile(args[1],args[2], JVMExecutor.Mods.STATIC,args[4],args[5],0,proxy,null);
                             ...
                             if(args[3].equalsIgnoreCase("DYNAMIC")){
                                 ...
                                 if(args.length == 7){
                                     try {
                                         ...
                                         jvmExecutor.updateConfigFile(args[1],args[2], JVMExecutor.Mods.DYNAMIC,args[4],args[5],Integer.parseInt(args[6]),proxy,null);
                                         Console.print(Colors.ANSI_GREEN()+"Vous venez de configurer le serveur avec succès !");
                                     }catch (Exception e){
                                         Console.print(Colors.ANSI_RED()+"Une erreur c'est produite, certainement car vous avez mal noté le port", Level.SEVERE);
                                     }
                                     ...
                                     try {
                                         ...
                                         jvmExecutor.updateConfigFile(args[1],args[2], JVMExecutor.Mods.DYNAMIC,args[4],args[5],0,proxy,null);
